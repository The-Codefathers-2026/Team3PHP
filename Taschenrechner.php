...
<body>
    ...
    <form action="Taschenrechner.php" method="post">
        <select size="5" disabled style="width: 100px; margin-bottom: 10px;">
            <?php foreach ($_SESSION['history'] as $eintrag): ?>
                <option><?php echo htmlspecialchars($eintrag); ?></option>
            <?php endforeach; ?>
        </select><br>
        ...
        <input type="submit" name="btnRC" value="RC">
